...
class Enemy {
  ...
  //audio saat game di mainkan
  let audio1 = new Audio();
  audio1.src = "musik.mp3";

  //suara saat gameover
  let GameoverSound = new Audio();
  GameoverSound.src = "game_over.mp3";

  //suara untuk tembakan
  let TembakanSound = new Audio();
  TembakanSound.src = "shot.mp3";

  //suara untuk tembakan
  let Kenamusuh = new Audio();
  Kenamusuh.src = "kena.mp3";
...
function animate() {
  ...
  enemies.forEach((enemy, enemyIndex) => {
    ...
    if (dist - enemy.radius - player.radius < 1) {
      ...
      GameoverSound.play(); //jika gameover
      audio1.pause();// matikan musik
      return;
    }
    ...
    projectiles.forEach((projectile, projectileIndex) => {
      ...
      if (dist - enemy.radius - projectile.radius < 1) {
        ...
        Kenamusuh.play(); //Jika proyektil kena musuh
      }
    });
  });
}
...
addEventListener("click", (event) => {
  ...
  TembakanSound.play(); // suara Jika kena musuh
});
...
startGameBtn.addEventListener("click", () => {
  ...
  enemies.length = 0;
  audio1.loop = true;
  audio1.play();// musik dimulai di awal game
